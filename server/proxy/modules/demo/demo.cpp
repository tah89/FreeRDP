...
BOOL proxy_module_entry_point(proxyPluginsManager* plugins_manager, void* userdata)
{
	...
	proxyPlugin plugin = {
		...
		.PluginUnload = demo_plugin_unload,                     /* PluginUnload */
		.ClientInitConnect = demo_client_init_connect,          /* ClientInitConnect */
		.ClientUninitConnect = demo_client_uninit_connect,      /* ClientUninitConnect */
		.ClientPreConnect = demo_client_pre_connect,            /* ClientPreConnect */
		.ClientPostConnect = demo_client_post_connect,          /* ClientPostConnect */
		.ClientPostDisconnect = demo_client_post_disconnect,    /* ClientPostDisconnect */
		.ClientX509Certificate = demo_client_x509_certificate,  /* ClientX509Certificate */
		.ClientLoginFailure = demo_client_login_failure,        /* ClientLoginFailure */
		.ClientEndPaint = demo_client_end_paint,                /* ClientEndPaint */
		.ServerPostConnect = demo_server_post_connect,          /* ServerPostConnect */
		.ServerPeerActivate = demo_server_peer_activate,        /* ServerPeerActivate */
		.ServerChannelsInit = demo_server_channels_init,        /* ServerChannelsInit */
		.ServerChannelsFree = demo_server_channels_free,        /* ServerChannelsFree */
		.ServerSessionEnd = demo_server_session_end,            /* ServerSessionEnd */
		.KeyboardEvent = demo_filter_keyboard_event,            /* KeyboardEvent */
		.MouseEvent = demo_mouse_event,                         /* MouseEvent */
		.ClientChannelData = demo_client_channel_data,          /* ClientChannelData */
		.ServerChannelData = demo_server_channel_data,          /* ServerChannelData */
		.DynamicChannelCreate = demo_dynamic_channel_create,    /* DynamicChannelCreate */
		.ServerFetchTargetAddr = demo_server_fetch_target_addr, /* ServerFetchTargetAddr */
		.ServerPeerLogon = demo_server_peer_logon,              /* ServerPeerLogon */
